...
public enum PoseLayers {
    ...
    public static let standing: [PoseLayer] = [
        ...
        PoseLayer(id: "ribs", kind: .mascot, region: .ribs, parent: "torso", pivot: (500.00000000000000, 1150.0000000000000), scale: (0.017821782178217838, 0.0000000000000000)),
        PoseLayer(id: "chest", kind: .mascot, region: .chest, parent: "torso", pivot: (500.00000000000000, 1150.0000000000000), scale: (0.0010000000000000000, 0.0000000000000000), translate: (0.0000000000000000, -1.5847407407407403)),
        PoseLayer(id: "bellyUpper", kind: .mascot, region: .bellyUpper, parent: "torso", pivot: (522.00000000000000, 1105.0000000000000), scale: (0.0030000000000000001, 0.0000000000000000), translate: (0.0000000000000000, -0.23614814814814811), extras: [.init(region: .lock, translate: (0.0000000000000000, -2.8703703703703702))]),
        PoseLayer(id: "bellyLower", kind: .mascot, region: .bellyLower, parent: "torso", pivot: (522.00000000000000, 1105.0000000000000), scale: (0.023762376237623783, 0.013755980861243744), extras: [.init(region: .lock, translate: (0.0000000000000000, -6.3148148148148149))]),
        ...
        PoseLayer(id: "lidSoft", kind: .lid, parent: "head", breathLid: true, close: 0.25000000000000000),
        PoseLayer(id: "lidHalf", kind: .lid, parent: "head", close: 0.55000000000000004),
        PoseLayer(id: "lidMostly", kind: .lid, parent: "head", close: 0.80000000000000004),
        PoseLayer(id: "lidClosed", kind: .lid, parent: "head", close: 1.0000000000000000),
        PoseLayer(id: "mouthPursed", kind: .mouth, parent: "head", mouthState: "pursed"),
        PoseLayer(id: "mouthTongue", kind: .mouth, parent: "head", mouthState: "tongue"),
        PoseLayer(id: "mouthSigh", kind: .mouth, parent: "head", mouthState: "sigh"),
        PoseLayer(id: "mouthNose", kind: .mouth, parent: "head", mouthState: "nose", phaseCue: .noseOut),
        PoseLayer(id: "mouthNoseLeft", kind: .mouth, parent: "head", mouthState: "noseLeft"),
        PoseLayer(id: "mouthNoseRight", kind: .mouth, parent: "head", mouthState: "noseRight"),
        PoseLayer(id: "mouthLion", kind: .mouth, parent: "head", mouthState: "lion"),
        PoseLayer(id: "mouthCheek", kind: .mouth, parent: "head", mouthState: "cheek"),
        PoseLayer(id: "markerBelly", kind: .marker, parent: "bellyLower"),
    ...
    public static let seated: [PoseLayer] = [
        ...
        PoseLayer(id: "ribs", kind: .mascot, region: .ribs, parent: "torso", pivot: (506.00000000000000, 1150.0000000000000), scale: (0.016752475247524767, 0.0000000000000000)),
        PoseLayer(id: "chest", kind: .mascot, region: .chest, parent: "torso", pivot: (506.00000000000000, 1150.0000000000000), scale: (0.00093999999999999997, 0.0000000000000000), translate: (0.0000000000000000, -1.4896562962962958)),
        PoseLayer(id: "bellyUpper", kind: .mascot, region: .bellyUpper, parent: "torso", pivot: (503.00000000000000, 1200.0000000000000), scale: (0.0028200000000000000, 0.0000000000000000), translate: (0.0000000000000000, -0.22197925925925921), extras: [.init(region: .lock, translate: (0.0000000000000000, -2.8703703703703702))]),
        PoseLayer(id: "bellyLower", kind: .mascot, region: .bellyLower, parent: "torso", pivot: (503.00000000000000, 1200.0000000000000), scale: (0.022336633663366356, 0.012930622009569119), extras: [.init(region: .lock, translate: (0.0000000000000000, -6.3148148148148149))]),
        PoseLayer(id: "tail", kind: .mascot, region: .tail, translate: (0.0000000000000000, 3.2148148148148148)),
